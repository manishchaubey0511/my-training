...
class StorageExportCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        return $this->state->emulateAreaCode(Area::AREA_ADMINHTML, function () use ($output) {
            ...
            if (!$client->determineBucketRegion($this->helper->getBucket())) {
            ...
            if ($this->coreFileStorage->getCurrentStorageCode() === \Ktpl\S3\Model\MediaStorage\File\Storage::STORAGE_MEDIA_S3) {
            ...
            /** @var \Ktpl\S3\Model\MediaStorage\File\Storage\S3 $destinationModel */
            $destinationModel = $this->coreFileStorage->getStorageModel(\Ktpl\S3\Model\MediaStorage\File\Storage::STORAGE_MEDIA_S3);

            /*Delete the Bucket Folder and recreate By : KTPL*/
            $destinationModel->clear();
            /*End of Delete the Bucket Folder and recreate*/
            $offset = 0;
