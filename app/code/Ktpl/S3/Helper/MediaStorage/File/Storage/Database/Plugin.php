<?php
namespace Ktpl\S3\Helper\MediaStorage\File\Storage\Database;
...
use Ktpl\S3\Model\MediaStorage\File\Storage\S3Factory;
...
class Plugin
{
    ...
    {
        if ($this->helper->checkS3Usage()) {
            /** @var \Ktpl\S3\Model\MediaStorage\File\Storage\S3 $storageModel */
